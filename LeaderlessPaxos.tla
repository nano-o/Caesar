...
--algorithm LeaderlessPaxos {
    ...
    define {
        ...
        \* The set of dependency records such that 
        Deps == UNION {
            [   strong : {strong}, 
...
*)
\* BEGIN TRANSLATION
\* Label propose of process initLeader at line 203 col 14 changed to propose_
\* Label phase2 of process initLeader at line 221 col 14 changed to phase2_
\* Label acc of process acc at line 305 col 17 changed to acc_
                             ...
                             /\ LET depsUnion == UNION {vote[p][self][<<bal[1],1>>].weak : p \in q} IN
                                  LET fastDeps == PossibleFastDeps(self, bal[1], q) IN
                                    /\ Assert(Cardinality(fastDeps) <= 1, 
                                              "Failure of assertion at line 227, column 21 of macro called at line 294, column 21.")
                                    /\ IF fastDeps # {}
...
start(self) == /\ pc[self] = "start"
               /\ Assert((self[2]) > 0, 
                         "Failure of assertion at line 281, column 9 of macro called at line 298, column 21.")
                       ...
                       /\ LET ps == {p \in q : <<bal[1],1>> \in DOMAIN vote[p][(self[1])]} IN
                            ...
                            /\ LET depsUnion == UNION {vote[p][(self[1])][<<bal[1],1>>].weak : p \in q} IN
                                 LET fastDeps == PossibleFastDeps((self[1]), bal[1], q) IN
                                   /\ Assert(Cardinality(fastDeps) <= 1, 
                                             "Failure of assertion at line 227, column 21 of macro called at line 300, column 21.")
                                   /\ IF fastDeps # {}
                                         THEN /\ \E ds \in fastDeps:
...
\* Last modified Thu Apr 14 14:02:22 EDT 2016 by nano
\* Created Tue Apr 12 22:31:08 EDT 2016 by nano
